...
Read BRIEF.md, CLAUDE.md, README.md and CONTENT.md before touching any file.
Then summarise back to me, in five lines, what this site is, how the deep
spaces are built, and the design rules you must not break.

Do not restructure anything yet. After the summary, wait for my task.
